...
public partial class KokoroContext : IDisposable {
	...
	public bool IsDisposedFully => MarkUsageState_Volatile == MarkUsageState_DisposedFlag;
	public bool IsDisposedFully_NV => _MarkUsageState == MarkUsageState_DisposedFlag;
